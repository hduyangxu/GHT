...
def run_experiment(dataset_name: str, use_ght: bool) -> None:
    input_len = 96
    output_len = 24
...
def main():
    for dataset_name in ["ETTh1", "ETTh2"]:
        ...
        run_experiment(dataset_name, use_ght=False)
        print(f"\n===== {dataset_name}: PatchTST + GHT =====")
        run_experiment(dataset_name, use_ght=True)
